                ...
                <tbody>
                    ...
                    if($num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            $edit_url           = $admin_base_url . 'edit_user.php?id=' . $id;
                            $change_password_url= $admin_base_url . 'change_user_password.php?id=' . $id;
                            $delete_url         = $admin_base_url . 'delete_user.php?id=' . $id;
                            $ban_url            = $admin_base_url . 'ban_user.php?id=' . $id;
                    ...
                    ?>
                        <tr class="even pointer">
                            ...
                            <td class=" ">
                                ...
                                <a href="<?php echo $change_password_url; ?>" ><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-gear"></i> Change Password</button></a>
                                ...
                                <a href="<?php echo $ban_url; ?>" ><button type="button" class="btn btn-warning btn-sm"><i class="fa"></i> Ban</button></a>                                                      
                            </td>
                        </tr>
                    <?php
                        }
