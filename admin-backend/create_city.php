<?php
    ...
    if(isset($_POST['form-sub']) && $_POST['form-sub'] == 1) {
        $city_name      = $mysqli->real_escape_string($_POST['name']);
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" action="<?php $admin_base_url; ?>create_city.php" class="form-horizontal form-label-left" method="POST">
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="cityname">City name <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="cityname" name="name" value="<?php echo $city_name; ?>" class="form-control" placeholder="Enter City Name">
                                </div>
                            </div>
